...
no_plot=no_plot,b3a=b3a,fix_dg=fix_dg,spire=spire,feedback=feedback, convert=convert
    ...
    if keyword_set(single_gauss) then begin
        ...
        if keyword_set(fixed_width) then begin
            ...
            if not keyword_set(spire) then begin
                ...
                parinfo[2].limited = [1,1] & parinfo[2].limits = [0.5*dl, 1.5*dl]
